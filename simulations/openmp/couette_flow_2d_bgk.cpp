...
static constexpr const char *PROBLEM_TYPE = "couette";
...
/// TRT le prende couette_flow_2d_trt.
...
/// Uso: couette_flow_2d_bgk [cartella_configurazioni]
...
int main(int argc, char **argv) {
  ...
  config::run_matching_configs(
      ...
      [&](const config::SimulationConfig &cfg, const toml::table &) {
        ...
        // Couette: parete inferiore rigida, parete superiore mobile, lati
        // sinistro e destro periodici (esclusi gli angoli, che appartengono
        // gia' alle due pareti orizzontali). Tutto ricavato da nx/ny.
