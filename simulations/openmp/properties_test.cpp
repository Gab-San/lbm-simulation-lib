...
//       << "  output_txt    file col profilo di velocita' lungo la
//       centerline\n";
// }
//
// } // namespace
...
int main(int argc, char **argv) {
  ...
  //            {}\n\tNumber " "of frames: {}\n\tFrames output: {}\n\tProfile
  //            output: {}", cfg.name, grid_size, cfg.reynolds, init_vel,
  ...
  //   // bordo, ma le quattro facce del dominio: tre pareti rigide + il lid
  //   mobile
  ...
  //   types::solid_mask_t solid_mask = Solid::compute_solid_mask<DIM>({},
  //   grid_size);
  //
